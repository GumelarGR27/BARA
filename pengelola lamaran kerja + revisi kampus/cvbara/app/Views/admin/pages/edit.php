        ...
        <div id="wrapper">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown">
                        <a class="dropdown-toggle a" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> <?php echo $log; ?> <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="<?php echo base_url('/reset'); ?>"><i class="fa fa-user fa-fw"></i> User Profile</a>
                            </li>
                            <li class="divider"></li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 style="margin-left:35%; padding-top:3%;">Edit Lowongan</h1>
                    ...
                    <form style="padding: 2% 2% 2% 2%;" action="<?php echo base_url('editdivisi'); ?>" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $request->getVar('nama'); ?>" name="nama">
                            </div>
                            <div class="form-group">
                            <textarea class="form-control" rows="3" placeholder="Masukkan Kriteria" name="kriteria" style="text-align: justify;"><?php echo $request->getVar('kriteria');?>
                            </textarea>
                            </div>
