...
<div class="module form-module">
  ...
  <div class="form">
    ...
    <form action="<?php echo base_url('/admin/login'); ?>" method="POST">
      <input type="password" placeholder="Masukan Password Baru" name="Password" required/>
      <input type="password" placeholder="Konfirmasi Password Baru" name="Password" required/>
