        ...
        <div id="wrapper">
            ...
            <div style="color:white; font-size: 13pt; float:left; width: 80%; padding-top: 15px; font-weight: 600; padding-left: 15px;">Kelola Lamaran Kerja</div>
                ...
                <div class="navbar-default sidebar" role="navigation" id="saidbar">
                    ...
                    <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('/diterima'); ?>" class="a active"><i class="far fa-check-circle" style="margin-right: 9px; margin-left: 1px;"></i> Diterima</a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Data Pelamar Yang Diterima</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        ...
                        <div class="panel panel-default" style="padding-top: 5px;">
                            <center><h2>Data Karyawan</h2></center>
                                <div class="panel-heading" style="height: 80px;">
                                    <form method="POST" action="<?php echo base_url('cariditerima'); ?>" class="form-group">
