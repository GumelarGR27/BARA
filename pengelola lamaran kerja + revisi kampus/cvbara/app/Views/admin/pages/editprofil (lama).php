<?php
    ...
    $kueri   = $db->query('SELECT * FROM users WHERE id = "'.$request->getVar('id').'"');
    ...
    $jwt = json_decode(base64_decode(str_replace('_', '/', str_replace('-','+',explode('.', $pw)[1]))));
    $ar = (array) $jwt;
    $decode = $ar['password'];
    $psw = openssl_decrypt($decode, "aes-256-cbc", "https://bara.co.id/", 0, md5("RaihanMP","GumelarGR"));
    $psw = json_decode($psw);
    $session = session();
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-default sidebar" role="navigation" id="saidbar">
                    ...
                    <ul class="nav" id="side-menu">
                            ...
                            ?>
                            <li>
                                <a href="<?php echo base_url('/reset'); ?>" class="a"><i class="fa fa-user fa-fw"  style="margin-right: 9px; margin-left: 1px;"></i> User Profile</a>
                            </li>
                            <li>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                ...
                <div class="container-fluid">
                    ...
                    <input type="text" class="form-control" id="pw" placeholder="Masukkan Password" value="<?php echo $psw; ?>" name="password">
                    <button type="button" id="ganti"></button>
                    </div>
                    <div class="form-group">
        ...
        <!-- <script>
            var pasw = document.getElementById('pw').value;
            //console.log(atob(pasw.split('.')[1]));  
            //var pasw = document.getElementById('pw').value = atob(pasw.split('.')[1]);
           var pasw = new Request.JSON({
