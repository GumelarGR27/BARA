            ...
            <div style="color:white; font-size: 13pt; float:left; width: 80%; padding-top: 15px; font-weight: 600; padding-left: 15px;">Kelola Lamaran Kerja</div>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> <?php echo $name." (".$role.")"; ?> <b class="caret"></b>
                        </a>
                ...
                <div class="navbar-default sidebar" role="navigation" id="saidbar">
                    ...
                    <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href=<?php echo base_url('/interview'); ?> class="a active"><i class="fa fad fa-hourglass-half" style="margin-right: 11px; margin-left: 2px;"></i> Interview</a>
                            </li>
                            <li>
                        ...
                        <div class="col-lg-12">
                            ...
                            <center><h2>Data Karyawan</h2></center>
                                <div class="panel-heading" style="height: 80px;">
                                    <form method="POST" action="<?php echo base_url('cariinterview'); ?>" class="form-group">
                                ...
                                <div class="panel-body" style="padding-top: 0px !important;">
                                    <table class="table table-bordered" style="width:90%; margin-left:5%;">
                                        ...
                                        <td>
                                            ...
                                            <form method="GET">
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="<?php echo base_url('acc?id=').$idpel.'&nama='.$name ?>" data-toggle="tooltip" style="text-decoration: none;" title="Terima Pelamar"><img src="<?php echo base_url('assets/img/terima.png') ?>" style="width:23px;"></a>
                                                </td>
                                                <td style="text-align: center;">
                                                    <a href="#" class="delete" data-toggle="tooltip" style="text-decoration: none;" title="Tolak Pelamar" data-id="<?php echo $idpel; ?>"><img src="<?php echo base_url('assets/img/cancel.png') ?>" style="width:20px;"></a>
                                                </td>
                                            </form>
                                        </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <form action="<?php echo base_url('menolak'); ?>" method="post">
