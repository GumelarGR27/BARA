        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 style="margin-left:35%; padding-top:3%;">Kirim Penilaian</h1>
                    ...
                    <form style="padding: 2% 2% 2% 2%;" action="<?php echo base_url('editdivisi'); ?>" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="3" placeholder="Masukkan Kriteria" name="email" style="text-align: justify;">
                                </textarea>
                            </div>
