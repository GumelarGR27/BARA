<?php
    ...
    $array = array('status' => 'Diterima');
    $terima = $data->where($array);
    $diterima = $terima->countAllResults();
    $arrayy = array('status' => 'Ditolak');
    $tolak = $data->where($arrayy);
    $ditolak = $tolak->countAllResults();
        ...
        <div id="wrapper">
            ...
            <div style="color:white; font-size: 13pt; float:left; width: 80%; padding-top: 15px; font-weight: 600; padding-left: 15px;">Kelola Lamaran Kerja</div>
                ...
                <div class="navbar-default sidebar" role="navigation" id="saidbar">
                    ...
                    <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('/ditolak'); ?>" class="a active"><i class="fa-solid fa-circle-xmark" style="margin-right: 9px; margin-left: 2px;" ></i> Ditolak</a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Data Pelamar Yang Ditolak</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right" style="color: #f0ad4e;">
                                            <div>Diterima</div>
                                            <div class="huge"><?php echo $diterima; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right" style="color: #d9534f;">
                                            <div>Ditolak</div>
                                            <div class="huge"><?php echo $ditolak; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default" style="padding-top: 5px;">
                            <center><h2>Data Karyawan</h2></center>
                                <div class="panel-heading" style="height: 80px;">
                                    <form method="POST" action="<?php echo base_url('cariditolak'); ?>" class="form-group">
                                        <select class="form-control" name="divisi" style="width:15%;float:left;margin-top: 10px; margin-left: 5%;" onchange="this.form.submit()">
                                        ...
                                        <div class="input-group"style="width:80% !important; float:left; padding-left: 49%;">
                                            <div class="form-outline" >
                                                <input type="search" name="cari" id="form1" class="form-control" style="width: 70%; margin-top: 10px;"/>
                                            </div>
                                            <button type="Submit" class="btn btn-primary" id="btn" style="margin-top: 10px;">
                                ...
                                <div class="panel-body" style="padding-top: 0px !important;">
                                                ...
                                                <td style="text-align: center;">
                                                    <?php
                                                        ...
                                                        foreach ($results as $rou) {
                                                            //$no = $rou->no;
                                                            $idpel = $rou->id_pelamar;
                                                            $nama = $rou->nama;
                                                        }
                                                    ?>
                                                    <a href="<?php echo base_url('cv?id=').$idpel ?>" data-toggle="tooltip" style="text-decoration: none;" title="Review CV"><img src="<?php echo base_url('assets/img/eye.png') ?>" style="width:26px;"></a>
                                                </td>
                                                <td style="text-align: center;">
                                                    <a href="#" class="delete" data-toggle="tooltip" style="text-decoration: none;" title="Hapus Pelamar" data-id="<?php echo $idpel; ?>"><img src="<?php echo base_url('assets/img/cancel.png') ?>" style="width:20px;"></a>
                                                </td>
                                            </form>
                                        </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <form action="<?php echo base_url('hapuspelamar'); ?>" method="post">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default" style="padding-top: 10px !important;">
                            <center><h2>Data Magang</h2></center>
