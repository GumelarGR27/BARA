                        ...
                        <div class="card card-primary">
                            ...
                            <form action="<?php echo base_url('/lamar'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Permintaan Gaji</label>
                                        <input type="text" class="form-control" placeholder="Masukkan Permintaan Gaji" name="gaji" id="email" required> 
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: 5px;">
                                        <label for="exampleInputFile" style="margin-top: 10px;">Masukkan Ijazah :</label>
                                        <div class="input-group">
                                            <div class="custom-file-upload">
                                                <span class="control-fileupload">
                                                    <label for="file">Pilih File</label>
                                                    <input type="file" id="file" onchange="" name="ijazah" accept="application/pdf">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $($(jenis).on('change', function() {
                    if($(jenis).val() == 'Magang'){
                        $(form).append('<div class="form-group" id="magang"><label for="exampleInputEmail1">Durasi Magang:</label><br><label for="exampleInputEmail1">Mulai</label><input type="date" class="form-control" name="mulai" min="<?php echo $min = date('Y-m-d'); ?>" required><label for="exampleInputEmail1">Akhir</label><input type="date" class="form-control" name="akhir" min="<?php $minn = strtotime($min); echo date("Y-m-d",strtotime("+1 month",$minn)); ?>" required></div>');
