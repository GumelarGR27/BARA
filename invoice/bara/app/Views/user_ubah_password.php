...
<div class="form-body">
    ...
    <div class="tab-content">
        ...
        <div class="innter-form">
            <form class="sa-innate-form" method="post" action="<?php $req = \Config\Services::request(); echo base_url('lupas?id='.$req->getVar('id')); ?>">
            <label>Ubah Password</label>
            <input type="password" name="password">
            <label>Konfirmasi Password</label>
            <input type="password" name="konpassword">
            <button type="submit" style="background-color: #fecb00 !important; color: #3b4155 !important;">Ubah</button>
            </form>
            </div>
