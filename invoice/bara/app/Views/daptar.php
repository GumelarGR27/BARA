...
<a href="<?php echo base_url('tambah'); ?>"><button type="button" class="btn btn-info" style="margin-bottom: 20px; float: left; margin-left: 10%;" type="button">Tambah Data Client</button></a>
...
<!-- <form method="POST"> -->
<table class="table table-striped" style = "width:80%; margin-bottom: 38px;">
  <tr>
  ...
  <tr>
    ...
    <td class="table-bordered"><?= $row['nama_perusahaan']; ?></td>
    <!-- <form method="post"> -->
    <td class="table-bordered">
        <a href="<?php echo base_url('/file_data?nama='.$row['nama_perusahaan']) ?>"><button type="button" class="btn btn-info">View</button></a>
        <a href="<?php echo base_url('Edit_Client?comp='.$row['nama_perusahaan']); ?>"><button type="button" class="btn btn-warning">Edit</button></a>
        <button type="button" class="btn btn-info btn-danger delete" data-id="<?= $row['id_klien']; ?>" data-toggle="modal" data-target="#myModal">Delete</button>
    </td>
  </tr>
  <?php endforeach;?>
</table>

<form action="<?php echo base_url('hapusklien'); ?>" method="post">
