<?php
    ...
    $noinv = $request->getVar('noinv');
    $query   = $db->query('SELECT * FROM tagihan WHERE no_invoice="'.$noinv.'"');
    ...
    $kweri   = $db->query('SELECT sum(total) as total FROM detail_tagihan WHERE id_tagihan="'.$idtag.'"');
