...
.sa-innate-form input[type=text], input[type=password], input[type=email], textarea, select, email{
    font-size:13px;
    padding:10px;
    ...
    <div class="tab-content">
        <div id="sectionA" class="tab-pane fade in active">
            <div class="innter-form">
                ...
                <?php endif;?>
                <form class="sa-innate-form" method="post" action="<?php echo base_url('login'); ?>">
                    <label>Email</label>
                    <input type="email" name="email"><br>
                    <label>Password</label>
                    <input type="password" name="password">
                    <button type="submit" style="background-color: #fecb00 !important; color: #3b4155 !important;">Sign In</button>
                    <!-- <a href="<?php echo base_url('/ubahpassword') ?>"><td>Forgot Password?</td></a> -->
                </form>
            </div>
