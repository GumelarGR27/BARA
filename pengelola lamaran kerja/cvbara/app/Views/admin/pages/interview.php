                                    ...
                                    <table class="table table-bordered" style="width:90%; margin-left:5%;">
                                        ...
                                        <td>
                                            ...
                                            <form method="GET">
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="<?php echo base_url('acc?id=').$idpel ?>" data-toggle="tooltip" style="text-decoration: none;" title="Terima Pelamar"><img src="<?php echo base_url('assets/img/terima.png') ?>" style="width:23px;"></a>
                                                </td>
                                                <td style="text-align: center;">
