                ...
                <form>
                    ...
                    <table >
                        ...
                        <div class="card-footer">
                            <tr>
                                <td colspan="2" style="padding-left: 130px; padding-top: 15px;"><a href="<?php echo base_url('/editprofil?id='.$roww->id); ?>" class="ed" style="color: white; text-decoration: none;"><button type="button" class="button">Edit Profil</button></a></td>
                            </tr>
                        </div>
                    </table>    
                    </div>
